...
const personalInfo = {
  ...
  contactMessage:
    "I'd love the opportunity to connect and discuss how our work and expertise might align to create something valuable together. Please don't hesitate to reach out if you believe there's potential for a mutually beneficial collaboration, I'd be excited to explore the possibilities",
};
...
const projects = [
  {
    ...
    description:
      "This app allows users to customize their resume directly on a preformatted layout. Fields are editable inline, making the resume creation process intuitive and efficient. Once complete, users can export their resume as a high-quality PDF with a single click.",
  },
  {
    id: 2,
    ...
    description:
      "This responsive Todo List application provides an intuitive and visually appealing interface for managing tasks efficiently. Featuring a dark and light mode!",
  },
  {
    id: 3,
    ...
    liveLink: "https://mini-message-board-production-4b46.up.railway.app/",
    description:
      "A lightweight full-stack application built with Node.js, Express, and EJS for server-side rendering. Feel free to leave me a message!",
  },
  {
    id: 4,
    ...
    description:
      "It's just a retro style clock.. Made with love (and CSS grid). Enjoy the brightness, and pretend it's 1985.",
  },
  {
    id: 5,
    projName: "Battleship",
    ...
    description:
      "Test your strategy and precision with this interactive Battleship game! Built entirely with HTML, CSS, and JavaScript, this game offers a sleek and engaging experience where players can challenge themselves to sink all enemy ships on a classic grid-based battlefield.",
  },
  {
    id: 6,
    ...
    description:
      "Challenge yourself or a friend to this timeless 2-player strategy game, now in a sleek and interactive web version. Built with a clean and responsive interface, this game delivers a smooth experience on desktop.",
  },
  {
    id: 7,
    ...
    description:
      "Enter the delicious world of this fictitious restaurant. The Aztecan Kitchen!",
  },
  // {
  //   id: 8,
